...
/**
 * This is a convenience class that extends from the support library Fragment and uses
 * ComponentControllerDelegate to control the lifespan of its non-configuration component.
 *
