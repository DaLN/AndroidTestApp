...
/**
 * A convenience class that extends from ComponentControllerFragment and utilizes
 * PresenterControllerDelegate to automatically call the lifecycle events of the associated
 * presenter class.
 *
